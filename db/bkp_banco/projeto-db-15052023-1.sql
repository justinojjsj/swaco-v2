...
--
-- Host: db
-- Tempo de geração: 15/05/2023 às 20:04
...
INSERT INTO `dados_paciente` (`id_pac`, `CPF`, `nome`, `celular`, `idade`, `estado_civil`, `email`, `work`, `gender`, `convenio`, `CEP`, `ad_number`, `street`, `district`, `city`, `state`, `modificado`) VALUES
(8, '123.456.789-10', 'Ronaldinho da Silva Junior', '1295698-8745', '03102021', 'gg', 'asdasdas@hotmail.com', 'g', 'homem', 'ggg', '12235000', '453', 'Avenida Guadalupe', 'Jardim América', 'São José dos Campos', 'SP', '2023-05-15 19:38:04'),
(9, '423.388.478-90', 'Joel Justino', '12 98107-3748', '03/10/1995', 'Casado', 'joelsaudesucesso@gmail.com', 'Aluno', 'homem', 'Particular', '12228710', '212', 'Rua H18A', 'Campus do CTA', 'São José dos Campos', 'SP', NULL),
(10, '666.666.666-66', 'Pi Justino Pereira', '13985698547', '20052019', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-15 19:40:06'),
(11, '1', 'TESTE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `consulta`
  ADD CONSTRAINT `consulta_ibfk_1` FOREIGN KEY (`id_pac`) REFERENCES `z_apagar_pacient` (`id_pac`),
  ADD CONSTRAINT `consulta_ibfk_2` FOREIGN KEY (`CRO`) REFERENCES `z_apagar_dentista` (`CRO`);
